...
document
  .querySelector("#transpositionEncryptBtn")
  .addEventListener("click", () => {
    const plainText = document
      .querySelector("#transpositionText")
      .value.toUpperCase()
      .replace(/\s/g, "");

    const keyword = document
      .querySelector("#transpositionKey")
      .value.toUpperCase();
    const encryptedText = transpositionEncrypt(plainText, keyword);
    document.querySelector("#transpositionOutput").value = encryptedText;
  });

document
  .querySelector("#transpositionDecryptBtn")
  .addEventListener("click", () => {
    ...
    const keyword = document
      .querySelector("#transpositionKey")
      .value.toUpperCase();
    const decryptedText = transpositionDecrypt(cipherText, keyword);
    document.querySelector("#transpositionOutput").value = decryptedText;
  });
